...
export enum PacketType {
  ...
  SHOW_ALLY_SHOOT = 'CHANGE_ALLYSHOOT',
  // TODO: implement these new packets
  SHOOTACK_COUNTER = 'SHOOTACK_COUNTER',
  CREEP_MOVE_MESSAGE = 'CREEP_MOVE_MESSAGE',
  GET_PLAYER_LIST_MESSAGE = 'GET_PLAYER_LIST_MESSAGE',
  PLAYERS_LIST_MESSAGE = 'PLAYERS_LIST_MESSAGE',
